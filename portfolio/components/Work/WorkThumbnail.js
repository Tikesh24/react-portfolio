...
const WorkThumbnail = ({work,date,thumbicon,url,discription}) =>{
    return (
        ...
        <div className=" font-light focus:border-b-2">
            <div className="relative pt-4 grid grid-cols-1 gap-2">
                <div className="rounded overflow-hidden shadow-lg bg-black">
                    <div className ="px-6 py-4 grid grid-cols-3 md:grid-cols-5 border-2  hover:border-2 border-transparent hover:border-green-600 transition delay-100 ease-in-out">
                        <div className="col-span-1 row-start-1">
                            <Image width="350" height="250" src={thumbicon!=="NA" && thumbicon!== undefined ?`${thumbicon}`:NO_IMAGE} />
                        </div>
